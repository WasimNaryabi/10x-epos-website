<template>
    <div class="app-wrapper">
        ...
        <main class="main-content">
            ...
            <!-- Solution Section -->
            <OurSolution @request-demo="openDemoModal" />
            ...
            <AIInnovation @request-demo="openDemoModal" />
...
import AboutHero from '@/Components/Website/AboutHero.vue';
import OurStory from '@/Components/Website/OurStory.vue';
import ProblemsFaced from '@/Components/Website/ProblemsFaced.vue';
import OurSolution from '@/Components/Website/OurSolution.vue';
import CoreValues from '@/Components/Website/CoreValues.vue';
import OurMission from '@/Components/Website/OurMission.vue';
import OurTeam from '@/Components/Website/OurTeam.vue';
import AIInnovation from '@/Components/Website/AIInnovation.vue';
import AboutCTA from '@/Components/Website/AboutCTA.vue';
